...
# 1p2d
# srtctl apply -f recipes/h100/1k1k/stp/h100-fp8-1p2d-max-dep.yaml
...
# 1p2d
# srtctl apply -f recipes/h100/8k1k/stp/h100-fp8-1p2d-max-dep.yaml
# srtctl apply -f recipes/h100/8k1k/mtp/h100-fp8-1p2d-max-dep-mtp.yaml
################################ 8k1k ################################
